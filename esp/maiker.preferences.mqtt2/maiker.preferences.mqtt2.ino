...
void reconnect() {
  while (!client.connected()) {
    ...
    client.subscribe("control/HREG_ON_MS_PUMP_0");
    client.subscribe("control/HREG_ON_MS_PUMP_1");
    client.subscribe("control/HREG_ON_MS_PUMP_2");

    client.subscribe("control/HREG_OFF_MS_PUMP_0");
    client.subscribe("control/HREG_OFF_MS_PUMP_1");
    client.subscribe("control/HREG_OFF_MS_PUMP_2");
  }
}